...
import in.icomputercoding.folkchat.databinding.ItemReceiveBinding;
import in.icomputercoding.folkchat.databinding.ItemSentBinding;
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            viewHolder.binding.message.setOnTouchListener((v, event) -> {
                ...
                if(isFeelingsEnabled)
                    ...
                    //Toast.makeText(context, "Wait for some time.", Toast.LENGTH_SHORT).show();
                return false;
                return true;
            });
            ...
            viewHolder.itemView.setOnLongClickListener(v -> {
                ...
                binding.everyone.setOnClickListener(v12 -> {
                    message.setMessage("This message is removed.");
                    message.setFeeling(-1);
                    FirebaseDatabase.getInstance().getReference()
                            .child("chats")
